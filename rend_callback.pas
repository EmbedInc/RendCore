...
begin
  ...
  rend_set.cpnt_2dim :=                {install routine that will do the callback}
...
begin
  rend_callback.vect_2dim_call_p := routine_p; {save pointer to callback routine}
  rend_callback.vect_2dim_state_p := app_p; {save pointer to pass to callback}
